...
#define MEM_EBDA_START              (0x00080000)          // EBDA显存信息存放空间
#define MEM_EXT_START               (1024*1024)           // 物理内存用户态空间起始地址, 1MB
#define MEM_EXT_END                 (128*1024*1024 - 1)   // 物理内存用户态空间结束地址, 128MB
...
{
    void * vstart;       // 虚拟地址起始地址
    void * vend;         // 虚拟地址结束地址
    void * pstart;       // 物理地址起始地址
    uint32_t perm;       // 访问权限
} memory_map_t;
